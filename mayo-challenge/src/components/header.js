...
import * as nav from "../images/navigation.json"
import './header.css'
...
const Header = () => {
  ...
  return (
    ...
    <header className="home__header">
          <nav>
              <ol className="home__header-topnav">
                  <li className="topnav-logo"> 
                  ...
                  <li className="topnav-item"><a>Program Features</a></li>
                  <li className="topnav-item"><a>Group Support</a></li>
                  <li className="topnav-item"><a>About Our Company</a></li>
              </ol>
          </nav>
          <nav>
              <button onClick={() => setActive(!active)} className="home__header-sidenav-button">MENU</button>
              <div className={`home__header-sidenav ${active? 'active':''}`}>
                <div>
                  <a onClick={() => setActive(!active)}>Home</a>
                  <button onClick={() => setActive(!active)}>Close</button>
                </div>
                <ol>
                  {nav.navigation.map((route, i) => {
                    return (
                      <li key={i}>
